...
## Phase 18-19 GA Evidence

- `corepack pnpm --filter @comath/comathd test` includes proof-kernel gate, ensemble recovery, campaign, refutation, and snapshot replay tests.
