...
## Phase 18-21 GA Vertical-Slice Evidence
...
- `corepack pnpm --filter @comath/pi-extension test` includes research/campaign command, tool descriptor tests, and read-only dashboard aggregation over claim/evidence/gate list routes.
