...
const allowed = new Set(["research_capabilities_get", "research_campaign_list", "research_campaign_start", "research_campaign_get", "research_frontier_get", "research_budget_get", "research_events_read", "research_dag_patch", "research_budget_update", "research_campaign_pause", "research_campaign_resume", "research_campaign_cancel", "research_campaign_finish", "research_task_get", "research_task_cancel", "research_task_retry", "research_checkpoint_get", "research_operation_get", "research_intake_prepare", "research_intake_request_approval"]);
