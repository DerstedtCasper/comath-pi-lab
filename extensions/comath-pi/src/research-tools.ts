...
const allowed = new Set(["research_capabilities_get", "research_campaign_start", "research_campaign_get", "research_campaign_pause", "research_campaign_resume", "research_campaign_cancel", "research_campaign_finish", "research_task_get", "research_task_cancel"]);
