...
assert.match(durableContractPlan.next_action.command, /--operator-approval-id LIFE-OPERATOR-APPROVAL-0244/);
assert.match(durableContractPlan.next_action.command, /--operator-approval-sha256 c{64}/);
