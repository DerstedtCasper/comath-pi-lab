...
const expectedNextActions = [
  ...
  },
  {
    ...
    action: "lifecycle-unattended-real-host-terminal-completion-certificate",
    command: /\/cm:release lifecycle-unattended-real-host-terminal-completion-certificate/
  },
  {
    completed: [
      "run-real-pi-runtime-probe",
    ...
    action: "lifecycle-operator-service-transport-closure-review",
    command: /\/cm:release lifecycle-operator-service-transport-closure-review/
  },
  {
    completed: [
      "run-real-pi-runtime-probe",
    ...
    action: "goal3-ga-operational-readiness-review",
    command: /\/cm:release goal3-ga-operational-readiness-review/
  },
  {
    completed: [
      "run-real-pi-runtime-probe",
    ...
    action: "goal3-ga-certification-review",
    command: /\/cm:release goal3-ga-certification-review/
  },
  {
    completed: [
      "run-real-pi-runtime-probe",
  ...
  },
  {
    ...
    action: "goal3-source-release-os-immutability-attestation",
    command: /\/cm:release goal3-source-release-os-immutability-attestation/
  },
  {
    completed: [
      "run-real-pi-runtime-probe",
  ...
  },
  {
    ...
    action: "goal3-proof-breadth-review",
    command: /\/cm:release goal3-proof-breadth-review/
  },
  {
    completed: [
      "run-real-pi-runtime-probe",
    ...
    action: "goal3-proof-breadth-closure",
    command: /\/cm:release goal3-proof-breadth-closure/
  },
  {
    completed: [
      "run-real-pi-runtime-probe",
