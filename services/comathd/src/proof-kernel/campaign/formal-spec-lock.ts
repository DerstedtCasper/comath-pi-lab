...
export function createProofObligationFromFormalSpecLock(input: {
  ...
  return proofObligationSchema.parse({
    ...
    locked_statement_structured: {
      ...
      claim_id: lock.claim_id,
      original_goal_text: lock.original_goal_text,
      original_goal_sha256: lock.original_goal_sha256,
      normalized_nl_statement: lock.normalized_nl_statement,
      ...
      theorem_type_elaborated_hash: lock.theorem_type_elaborated_hash,
      ...
      imports_allowed: lock.imports_allowed,
      external_dependencies_allowed: lock.external_dependencies_allowed,
      trust_profile_id: lock.trust_profile_id,
      statement_hash: lock.statement_hash,
      locked_by: lock.locked_by,
      locked_at: lock.locked_at,
      user_approval_required: lock.user_approval_required,
      proof_authority: lock.proof_authority
    },
