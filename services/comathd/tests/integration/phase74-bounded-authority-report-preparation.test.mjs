...
try {
  ...
  for (const relPath of [targetRel, proofBodyRel, prepRel, staticRel, statementRel, dependencyRel, axiomRel, replayTargetRel]) {
  ...
  assert.equal(prep.can_run_clean_replay, true);
