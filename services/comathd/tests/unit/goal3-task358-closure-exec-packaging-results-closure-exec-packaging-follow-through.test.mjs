...
const projectRoot = mkdtempSync(join(tmpdir(), "comath-goal3-task358-closure-exec-packaging-follow-through-"));
const repoRoot = fileURLToPath(new URL("../../../..", import.meta.url));
const { project } = initProject({
  name: "Goal 3 Task358 selected tranche closure execution packaging follow-through",
...
function seedTask347Artifact({
  task347Id = "GOAL3-SELECTED-TRANCHE-NEXT-CLOSURE-PACKAGING-RESULTS-0358",
  task341Id = "GOAL3-SELECTED-TRANCHE-NEXT-PACKAGING-RESULTS-0358",
  ...
  const task335 = dummyArtifact(
    "GOAL3-SELECTED-TRANCHE-PACKAGING-RESULTS-0358",
  ...
  const task341 = writeJson(task341Path, {
    ...
    project_id: projectId,
    actor: "goal3-task358 task341 seed",
    ...
    selected_tranche_packaging_results_follow_up_id: "GOAL3-SELECTED-TRANCHE-PACKAGING-RESULTS-0358",
  ...
  const task346 = dummyArtifact(
    "GOAL3-SELECTED-TRANCHE-NEXT-CLOSURE-PACKAGING-0358",
  ...
  const task344 = dummyArtifact(
    "GOAL3-SELECTED-TRANCHE-NEXT-CLOSURE-BRIDGE-0358",
  ...
  const task338 = dummyArtifact(
    "GOAL3-SELECTED-TRANCHE-NEXT-BRIDGE-0358",
  ...
  const task340 = dummyArtifact(
    "GOAL3-SELECTED-TRANCHE-NEXT-PACKAGING-0358",
  ...
  const task334 = dummyArtifact(
    "GOAL3-TASK-LOCAL-PACKAGING-0358",
  ...
  return writeJson(task347Path, {
    ...
    project_id: projectId,
    actor: "goal3-task358 task347 seed",
    created_at: "2026-06-13T00:00:00.000Z",
    ok: true,
    ...
    selected_tranche_next_closure_packaging_follow_through_id: "GOAL3-SELECTED-TRANCHE-NEXT-CLOSURE-PACKAGING-0358",
    ...
    selected_tranche_next_closure_execution_bridge_id: "GOAL3-SELECTED-TRANCHE-NEXT-CLOSURE-BRIDGE-0358",
    ...
    delegated_selected_tranche_next_execution_bridge_id: "GOAL3-SELECTED-TRANCHE-NEXT-BRIDGE-0358",
    ...
    selected_tranche_next_packaging_follow_through_id: "GOAL3-SELECTED-TRANCHE-NEXT-PACKAGING-0358",
    ...
    task_local_packaging_follow_through_id: "GOAL3-TASK-LOCAL-PACKAGING-0358",
...
function seedTask349Artifact({ task349Id = "GOAL3-SELECTED-TRANCHE-NEXT-CLOSURE-PACKAGING-RESULTS-CLOSURE-0358" } = {}) {
  ...
  return recordGoal3ReleaseCandidateProofBreadthSelectedTrancheNextClosurePackagingResultsClosureRecheck(projectRoot, {
    ...
    actor: "goal3-task358 task349 seed"
  });
}

function seedTask350Artifact({ task350Id = "GOAL3-SELECTED-TRANCHE-NEXT-CLOSURE-PACKAGING-RESULTS-CLOSURE-BRIDGE-0358" } = {}) {
  ...
  return recordGoal3ReleaseCandidateProofBreadthSelectedTrancheNextClosurePackagingResultsClosureExecutionBridge(
    projectRoot,
    {
      ...
      selected_tranche_next_closure_execution_bridge_id: "GOAL3-SELECTED-TRANCHE-NEXT-CLOSURE-BRIDGE-0358-DELEGATED",
      selected_tranche_next_execution_bridge_id: "GOAL3-SELECTED-TRANCHE-NEXT-BRIDGE-0358-DELEGATED",
      proof_breadth_execution_bridge_id: "GOAL3-PROOF-BREADTH-BRIDGE-0358-DELEGATED",
      ...
      actor: "goal3-task358 task350 seed token=plain-token proof_success GA certified can_certify_ga=true",
      proof_authority: "lean_kernel_clean_replay",
      can_certify_ga: true,
      max_tranche_size: 2
    }
...
function seedTask356Artifact({
  task356Id = "GOAL3-SELECTED-TRANCHE-NEXT-CLOSURE-EXEC-PACKAGING-RESULTS-CLOSURE-BRIDGE-0358",
  task350 = seedTask350Artifact()
} = {}) {
  const task355 = dummyArtifact(
    "GOAL3-SELECTED-TRANCHE-NEXT-CLOSURE-EXEC-PACKAGING-RESULTS-CLOSURE-0358",
  ...
  const task353 = dummyArtifact(
    "GOAL3-SELECTED-TRANCHE-NEXT-CLOSURE-EXEC-PACKAGING-RESULTS-0358",
  ...
  return writeJson(task356Path, {
    ...
    selected_tranche_next_closure_packaging_results_closure_execution_packaging_results_closure_execution_bridge_id:
      task356Id,
    project_id: projectId,
    actor: "goal3-task358 task356 seed token=plain-token proof_success GA certified can_certify_ga=true",
    created_at: "2026-06-13T00:00:00.000Z",
    ok: task350.ok,
...
try {
  assert.equal(
    ...
    "function",
    "Task358 must export a Task356-bound closure execution packaging follow-through"
  );
  assert.equal(
    ...
    true,
    "Task358 capability ledger must advertise closure execution packaging follow-through without authority"
  );
  assert.match(
    repoFile("scripts/phase0-smoke.mjs"),
    /goal3-task358-closure-exec-packaging-results-closure-exec-packaging-follow-through\.test\.mjs/s,
    "phase0 smoke must discover the Task358 focused suite"
  );
  ...
  assert.match(
    ...
    "Task358 must delegate Task356-bound closure execution packaging to existing Task352/346/340/334 semantics"
  );
  for (const forbiddenPattern of [
    ...
    assert.doesNotMatch(
      task358Source,
      forbiddenPattern,
      "Task358 must remain a Task356-to-Task352 handoff with no Lean, direct Task326/334/338/340/344/300/301/303, or certificate writes"
    );
  }
  ...
  assert.throws(
      ...
      recordGoal3ReleaseCandidateProofBreadthSelectedTrancheNextClosurePackagingResultsClosureExecutionPackagingResultsClosureExecutionPackagingFollowThrough(
        projectRoot,
        {
          ...
          selected_tranche_next_closure_packaging_results_closure_execution_packaging_results_closure_execution_packaging_follow_through_id:
            "GOAL3-SELECTED-TRANCHE-NEXT-CLOSURE-EXEC-PACKAGING-RESULTS-CLOSURE-EXEC-PACKAGING-0358-STALE",
          selected_tranche_next_closure_packaging_results_closure_execution_packaging_results_closure_execution_bridge_id:
    ...
    "Task358 must reject stale Task356 artifacts before delegating to Task352"
  );

  const weakenedPath =
    task356.body.selected_tranche_next_closure_packaging_results_closure_execution_packaging_results_closure_execution_bridge_path;
  const originalTask356Text = readFileSync(join(projectRoot, weakenedPath), "utf8");
  const weakenedBody = JSON.parse(originalTask356Text);
  ...
  assert.throws(
    () =>
      recordGoal3ReleaseCandidateProofBreadthSelectedTrancheNextClosurePackagingResultsClosureExecutionPackagingResultsClosureExecutionPackagingFollowThrough(
        projectRoot,
        {
          project_id: projectId,
          selected_tranche_next_closure_packaging_results_closure_execution_packaging_results_closure_execution_packaging_follow_through_id:
            "GOAL3-SELECTED-TRANCHE-NEXT-CLOSURE-EXEC-PACKAGING-RESULTS-CLOSURE-EXEC-PACKAGING-0358-WEAKENED",
          selected_tranche_next_closure_packaging_results_closure_execution_packaging_results_closure_execution_bridge_id:
            task356.body.selected_tranche_next_closure_packaging_results_closure_execution_packaging_results_closure_execution_bridge_id,
          selected_tranche_next_closure_packaging_results_closure_execution_packaging_results_closure_execution_bridge_path:
            weakenedPath,
    ...
    "Task358 must reject current Task356 artifacts with weakened no-authority flags"
  );
  writeFileSync(join(projectRoot, weakenedPath), originalTask356Text, "utf8");

  const driftBody = JSON.parse(originalTask356Text);
  const driftTask350 = dummyArtifact(
    "GOAL3-SELECTED-TRANCHE-NEXT-CLOSURE-PACKAGING-RESULTS-CLOSURE-BRIDGE-0358-DRIFT",
  ...
  const driftText = `${JSON.stringify(
    {
      ...
      delegated_selected_tranche_next_closure_packaging_results_closure_execution_bridge_id:
        "GOAL3-SELECTED-TRANCHE-NEXT-CLOSURE-PACKAGING-RESULTS-CLOSURE-BRIDGE-0358-DRIFT",
      delegated_selected_tranche_next_closure_packaging_results_closure_execution_bridge_path: driftTask350.path,
      delegated_selected_tranche_next_closure_packaging_results_closure_execution_bridge_artifact: driftTask350.artifact
    },
    null,
    2
  )}\n`;
  ...
  assert.throws(
    () =>
      recordGoal3ReleaseCandidateProofBreadthSelectedTrancheNextClosurePackagingResultsClosureExecutionPackagingResultsClosureExecutionPackagingFollowThrough(
        projectRoot,
        {
          project_id: projectId,
          selected_tranche_next_closure_packaging_results_closure_execution_packaging_results_closure_execution_packaging_follow_through_id:
            "GOAL3-SELECTED-TRANCHE-NEXT-CLOSURE-EXEC-PACKAGING-RESULTS-CLOSURE-EXEC-PACKAGING-0358-DRIFT",
          selected_tranche_next_closure_packaging_results_closure_execution_packaging_results_closure_execution_bridge_id:
            task356.body.selected_tranche_next_closure_packaging_results_closure_execution_packaging_results_closure_execution_bridge_id,
          selected_tranche_next_closure_packaging_results_closure_execution_packaging_results_closure_execution_bridge_path:
            weakenedPath,
    ...
    "Task358 must reject Task356 artifacts whose delegated Task350 reference drifts"
  );
  writeFileSync(join(projectRoot, weakenedPath), originalTask356Text, "utf8");
  ...
  assert.throws(
    () =>
      recordGoal3ReleaseCandidateProofBreadthSelectedTrancheNextClosurePackagingResultsClosureExecutionPackagingResultsClosureExecutionPackagingFollowThrough(
        projectRoot,
        {
          project_id: projectId,
          selected_tranche_next_closure_packaging_results_closure_execution_packaging_results_closure_execution_packaging_follow_through_id:
            "GOAL3-SELECTED-TRANCHE-NEXT-CLOSURE-EXEC-PACKAGING-RESULTS-CLOSURE-EXEC-PACKAGING-0358-UNSELECTED",
          selected_tranche_next_closure_packaging_results_closure_execution_packaging_results_closure_execution_bridge_id:
            task356.body.selected_tranche_next_closure_packaging_results_closure_execution_packaging_results_closure_execution_bridge_id,
          selected_tranche_next_closure_packaging_results_closure_execution_packaging_results_closure_execution_bridge_path:
            task356.body.selected_tranche_next_closure_packaging_results_closure_execution_packaging_results_closure_execution_bridge_path,
    ...
    "Task358 must let delegated Task352/346 reject evidence outside the Task356-selected next tranche"
  );
  ...
  const followThrough =
    recordGoal3ReleaseCandidateProofBreadthSelectedTrancheNextClosurePackagingResultsClosureExecutionPackagingResultsClosureExecutionPackagingFollowThrough(
      projectRoot,
      {
        project_id: projectId,
        selected_tranche_next_closure_packaging_results_closure_execution_packaging_results_closure_execution_packaging_follow_through_id:
          "GOAL3-SELECTED-TRANCHE-NEXT-CLOSURE-EXEC-PACKAGING-RESULTS-CLOSURE-EXEC-PACKAGING-0358",
        selected_tranche_next_closure_packaging_results_closure_execution_packaging_results_closure_execution_bridge_id:
          task356.body.selected_tranche_next_closure_packaging_results_closure_execution_packaging_results_closure_execution_bridge_id,
        selected_tranche_next_closure_packaging_results_closure_execution_packaging_results_closure_execution_bridge_path:
          task356.body.selected_tranche_next_closure_packaging_results_closure_execution_packaging_results_closure_execution_bridge_path,
        ...
        selected_tranche_next_closure_packaging_results_closure_execution_packaging_follow_through_id:
          "G3-T358-T352-OK",
        selected_tranche_next_closure_packaging_follow_through_id: "G3-T358-T346-OK",
        selected_tranche_next_packaging_follow_through_id: "G3-T358-T340-OK",
        task_local_packaging_follow_through_id: "G3-T358-T334-OK",
        claim_id_prefix: "C-T358",
        actor: "goal3-task358 token=plain-token proof_success GA certified can_certify_ga=true",
  ...
  assert.equal(
    followThrough.selected_tranche_next_closure_packaging_results_closure_execution_packaging_results_closure_execution_bridge_artifact.sha256,
    task356.sha256
  );
  assert.equal(
    followThrough.delegated_selected_tranche_next_closure_packaging_results_closure_execution_packaging_follow_through_artifact.kind,
  ...
  assert.equal(
    followThrough.delegated_selected_tranche_next_closure_packaging_results_closure_execution_bridge_id,
    task350.selected_tranche_next_closure_packaging_results_closure_execution_bridge_id
  );
  ...
  assert.deepEqual(
    ...
    closureFilesBefore,
    "Task358 must not write Task300 proof-breadth closure artifacts"
  );
  assert.deepEqual(
    collectRelativeFiles(".comath/release/goal3-final-ga-audit"),
    finalAuditFilesBefore,
    "Task358 must not write Task301 final-GA-audit artifacts"
  );
  assert.deepEqual(
    collectRelativeFiles(".comath/release/goal3-ga-certificate"),
    gaCertificateFilesBefore,
    "Task358 must not write Task303 GA-certificate artifacts"
  );

  const persisted = readJson(
    followThrough.selected_tranche_next_closure_packaging_results_closure_execution_packaging_results_closure_execution_packaging_follow_through_path
  );
  assert.equal(
    persisted.selected_tranche_next_closure_packaging_results_closure_execution_packaging_results_closure_execution_packaging_follow_through_artifact,
    undefined,
    "persisted Task358 follow-through must not self-hash recursively"
  );
  assert.equal(
    persisted.delegated_selected_tranche_next_closure_packaging_results_closure_execution_packaging_follow_through,
    undefined,
    "Task358 persisted artifact must bind delegated Task352 by artifact reference instead of embedding packaging reports"
  );

  const server = createComathServer();
  const routeResponse = await server.inject({
    method: "POST",
    path: "/release/goal3/selected-tranche-next-closure-packaging-results-closure-execution-packaging-results-closure-execution-packaging-follow-through",
    body: {
      project_root: projectRoot,
      project_id: projectId,
      selected_tranche_next_closure_packaging_results_closure_execution_packaging_results_closure_execution_packaging_follow_through_id:
        "GOAL3-SELECTED-TRANCHE-NEXT-CLOSURE-EXEC-PACKAGING-RESULTS-CLOSURE-EXEC-PACKAGING-0358-ROUTE",
      selected_tranche_next_closure_packaging_results_closure_execution_packaging_results_closure_execution_bridge_id:
        task356.body.selected_tranche_next_closure_packaging_results_closure_execution_packaging_results_closure_execution_bridge_id,
      selected_tranche_next_closure_packaging_results_closure_execution_packaging_results_closure_execution_bridge_path:
        task356.body.selected_tranche_next_closure_packaging_results_closure_execution_packaging_results_closure_execution_bridge_path,
      selected_tranche_next_closure_packaging_results_closure_execution_packaging_results_closure_execution_bridge_sha256:
        task356.sha256,
      actor: "goal3-task358 route token=plain-token proof_success GA certified can_certify_ga=true",
      evidence_by_task_id: Object.fromEntries(task350.next_execution_task_ids.map((taskId) => [taskId, forgedSuccessEvidence])),
      proof_authority: "lean_kernel_clean_replay",
      can_certify_ga: true
    }
  ...
  assert.equal(
    auditEvents.some(
      (entry) =>
        ...
        entry.payload.selected_tranche_next_closure_packaging_results_closure_execution_packaging_results_closure_execution_packaging_follow_through_id ===
          "GOAL3-SELECTED-TRANCHE-NEXT-CLOSURE-EXEC-PACKAGING-RESULTS-CLOSURE-EXEC-PACKAGING-0358-ROUTE" &&
        entry.payload.can_certify_ga === false &&
        entry.payload.proof_authority === "none"
    ),
    true,
    "Task358 must emit non-certifying provenance"
  );
  ...
  for (const forbiddenPattern of [
    ...
    assert.doesNotMatch(repoFile("extensions/comath-pi/src/index.ts"), forbiddenPattern, "Task358 must not add a Pi tool surface");
    assert.doesNotMatch(
      repoFile("extensions/comath-pi/src/runtime-registration.ts"),
      forbiddenPattern,
      "Task358 must not add a Pi runtime command"
    );
  }

  for (const [path, pattern] of [
    ["README.md", /Task358.*selected-tranche.*closure execution packaging results closure execution packaging follow-through/s],
    ["TODO.md", /Task358.*selected-tranche.*closure execution packaging results closure execution packaging follow-through/s],
    ["goal-3/tasks.md", /Task358.*selected-tranche.*closure execution packaging results closure execution packaging follow-through/s],
    ["REVIEW.md", /Goal 3 Task 358/s],
    ["AGENTS.md", /Task358.*selected-tranche.*closure execution packaging results closure execution packaging follow-through/s],
    ["docs/architecture/ga-release-criteria.md", /Task358.*selected-tranche.*closure execution packaging results closure execution packaging follow-through/s],
    ["docs/architecture/threat-model.md", /Task358.*selected-tranche.*closure execution packaging results closure execution packaging follow-through/s],
    ["docs/architecture/acceptance-matrix.md", /Task358.*selected-tranche.*closure execution packaging results closure execution packaging follow-through/s],
    ["docs/progress/goal-3-ga-gap-matrix.md", /Task358.*selected-tranche.*closure execution packaging results closure execution packaging follow-through/s]
  ]) {
    assert.match(
      repoFile(path),
      pattern,
      `${path} must document Task358 selected-tranche closure execution packaging results closure execution packaging follow-through`
    );
  }
} finally {
...
console.log("Goal 3 Task358 selected-tranche closure execution packaging results closure execution packaging follow-through tests passed.");
