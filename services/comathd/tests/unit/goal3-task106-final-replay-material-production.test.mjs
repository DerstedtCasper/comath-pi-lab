...
function writeSelectedCandidateMaterialSource({ campaignId, claim, claimStatement, theoremName, leanRootRel }) {
...
try {
  ...
  writeSelectedCandidateMaterialSource({ campaignId, claim, claimStatement, theoremName, leanRootRel });
