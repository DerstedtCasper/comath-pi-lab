...
try {
  ...
  assert.equal(report.blocker_code, "lean_authority_evidence_incomplete");
  assert.match(report.blocker_detail, /Injected replay callbacks cannot produce final Lean Authority evidence/);
