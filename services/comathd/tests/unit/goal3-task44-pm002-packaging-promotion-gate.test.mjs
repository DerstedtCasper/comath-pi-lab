...
try {
  ...
  appendFinalReplayRegistryEntryV3(projectRoot, finalReplayManifest, { project_id: project.project_id, actor: "goal3-task44" });
  ...
  const legacyRejected = promoteClaim(projectRoot, {
    project_id: project.project_id,
    claim_id: claim.id,
    target_status: "formally_checked",
    evidence_ids: [leanEvidence.id],
  ...
  assert.equal(legacyRejected.gate.ok, false, "legacy PM-002 v1 packaging must not be promotion-grade final authority evidence");
