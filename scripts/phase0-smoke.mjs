...
const releaseHardeningFocusedSuites = [
  ...
  "goal3-task201-agent-adapter-os-isolation-provider-helper-release-chain-check-debug.test.mjs",
  ...
  "goal3-task227-pi-automatic-real-pi-execution-orchestration.test.mjs",
  "goal3-task228-pi-automatic-real-pi-execution-consumer.test.mjs",
  "goal3-task229-pi-operator-service-transport-continuity.test.mjs",
  "goal3-task230-pi-operator-service-transport-continuity-consumer.test.mjs",
  ...
  "goal3-task241-pi-unattended-real-host-execution-readiness-blocker.test.mjs",
  "goal3-task242-pi-unattended-real-host-execution-readiness-consumer.test.mjs",
  "goal3-task243-pi-unattended-real-host-operator-approval-contract.test.mjs",
  "goal3-task244-pi-unattended-real-host-operator-approval-consumer.test.mjs",
  "goal3-task245-pi-unattended-real-host-executor-contract.test.mjs",
  "goal3-task246-pi-unattended-real-host-executor-contract-consumer.test.mjs",
  "goal3-task247-pi-unattended-real-host-durable-transport-contract.test.mjs",
  "goal3-task248-pi-unattended-real-host-durable-transport-contract-consumer.test.mjs",
  "goal3-task249-pi-unattended-real-host-execution-attempt.test.mjs",
  "goal3-task250-pi-unattended-real-host-execution-attempt-consumer.test.mjs",
  "goal3-task251-service-owned-unattended-real-host-execution-attempt-review.test.mjs",
  "goal3-task252-pi-unattended-real-host-execution-attempt-review-consumer.test.mjs",
  ...
  "goal3-task284-pi-lifecycle-readiness-completion-prerequisite-binding.test.mjs",
  "goal3-task285-pi-lifecycle-readiness-prerequisite-consumer.test.mjs",
  "goal3-task286-service-owned-terminal-completion-certificate-design.test.mjs",
  "goal3-task287-pi-unattended-real-host-terminal-completion-certificate-design-consumer.test.mjs",
  "goal3-task288-service-owned-terminal-completion-certificate.test.mjs",
  "goal3-task289-pi-unattended-real-host-terminal-completion-certificate-consumer.test.mjs",
  "goal3-task290-service-owned-operator-transport-closure-review.test.mjs",
  "goal3-task291-pi-operator-service-transport-closure-review-consumer.test.mjs",
  "goal3-task292-service-owned-ga-operational-readiness-review.test.mjs",
  "goal3-task293-pi-ga-operational-readiness-review-consumer.test.mjs",
  ...
  "goal3-task299-pm001-task-local-final-authority-packaging.test.mjs",
  "goal3-task300-proof-breadth-closure-verifier.test.mjs",
  "goal3-task301-final-ga-audit-proof-breadth-closure-binding.test.mjs",
  "goal3-task302-ga-certification-final-audit-binding.test.mjs",
  ...
  "goal3-task307-source-bound-release-package.test.mjs",
  "goal3-task308-source-only-open-source-review-artifact-binding.test.mjs",
  ...
  "goal3-task313-source-release-external-provider-verification.test.mjs",
  ...
  "goal3-task325-pi-final-release-candidate-closure-audit-consumer.test.mjs",
  ...
  "goal3-task260-pi-goal-mode-skeleton-blueprint-from-hints.test.mjs",
  "goal3-task261-pi-goal-mode-blueprint-bound-candidate-generation.test.mjs",
  "goal3-task262-pi-goal-mode-blueprint-lean-candidate-attempts.test.mjs",
  "goal3-task263-pi-goal-mode-lean-attempt-check-report.test.mjs",
  "goal3-task264-pi-goal-mode-lean-attempt-repair-routing.test.mjs",
  "goal3-task265-pi-goal-mode-repair-stage-reingestion.test.mjs",
  "goal3-task266-pi-goal-mode-ready-attempt-leanrunner-blocker.test.mjs",
  "goal3-task267-pi-goal-mode-leanrunner-feedback-repair-loop.test.mjs",
  "goal3-task268-pi-goal-mode-repair-hint-bundle.test.mjs",
  "goal3-task269-pi-goal-mode-repair-hint-execution.test.mjs",
  "goal3-task270-pi-goal-mode-placeholder-free-repair-candidate.test.mjs",
  "goal3-task271-pi-goal-mode-final-replay-terminal.test.mjs",
  "goal3-task272-pi-goal-mode-rfl-final-replay-terminal.test.mjs",
  "goal3-task273-pi-goal-mode-live-retrieval-repair-hint-execution.test.mjs",
  "goal3-task274-pi-goal-mode-live-retrieval-suggestion-repair.test.mjs",
...
for (const envName of [
  ...
  "COMATH_AGENT_ADAPTER_OSISO_OCI_LIVE_PROBE_ARGS_JSON",
  ...
  "COMATH_AGENT_ADAPTER_OSISO_PROVIDER_SPECIFIC_LIVE_PROBE",
  "COMATH_AGENT_ADAPTER_OSISO_PROVIDER_SPECIFIC_LIVE_PROBE_ARGS_JSON"
]) {
