...
| Product must not be a rough scaffold. | `README.md` describes Phase 18-76 product surfaces; `TODO.md` marks Phases 60-76 complete; `REVIEW.md` records Phase 60-76 evidence. | In scope and product-real for registered slices plus fail-closed planning/repair/target-package/proof-body/authority-preview/final-replay evidence. | Continue one task per Goal 2 turn until final audit can prove completion. |
